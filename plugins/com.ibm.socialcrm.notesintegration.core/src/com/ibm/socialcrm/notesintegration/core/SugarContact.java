...
public class SugarContact extends BaseSugarEntry {
	...
	public SugarContact(String id, String name) {
		super(id, name);
	}
	...
	public String getSugarUrl() {
		String aUrl = NotesAccountManager.getInstance().getCRMServer() + "index.php?module=Contacts&action=DetailView&record=" + getId(); //$NON-NLS-1$
